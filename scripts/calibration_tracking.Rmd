...
p1 <- chl_corr1154_plot %>%
  ...
  geom_col(position = "identity", colour = "black", width = 0.75) +
...
ggsave(here("figures", "Cali_red_diff_scorr.png"), fig, width=16, height=12, dpi=300)
```
```{r}
#This is not my official figure showing the difference in Chlorophyll when back calibrating with the 2018 DFO calibration (instrument 1154)
