...
ggsave(here("figures", "chl_max_dep.png"), fig,
...
ggsave(here("figures", "QU39_timeseries_filter_type_PERC.png"),
       width = 16, height = 14, dpi = 300)
```
...
ggsave(here("figures", "DFO2_timeseries_filter_type.png"),
       width = 16, height = 14, dpi = 300)
```
```{r}
c_dm %>% 
...
ggsave(here("figures", "KC10_timeseries_filter_type.png"),
       width = 16, height = 14, dpi = 300)
```
