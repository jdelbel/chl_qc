...
ggsave(here("figures_qc", "timeseries_qu39_bulk_no-flag_2023-01-04.png"),
        width = 16, height = 12, dpi = 300)
```
...
Look at relationship of samples by shipment

```{r}
#Make a list of samples from the first and second shipment
...
```{r}
chl_bulk3 %>% 
  filter(line_out_depth < 50 & shipment == "2018-05-28") %>%
