...
This workbook quantifies how many samples were collected in 2021 - at which stations, depths and groups.
...
chl %>% 
  ...
  ggsci::scale_fill_npg(name = "Filter Size",
                        labels = c(">20.0um (Micro)", "3.0-20.0um (Nano)", 
                                   "0.7-3.0um (Pico)", "Bulk")) +
  ylim(0, 1500) +
  ylab("# of samples") +
  ggtitle(2021) +
...
ggsave(here("figs_invent", "sample_numbers_by_group.png"), 
...
f1 <- chl %>% 
  ...
  ylab("# of samples") +
  theme_bw() +
  theme(legend.position = c(0.13, 0.83),
        axis.title.x = element_blank(),
...
ggsave(here("figs_invent", "sample_numbers_ocean.png"), fig,
