...
ggsave(here("figs_invent", "sample_numbers_calvert_2023.png"), 
...
```{r}
#Plotting chl max depth distribution for QU39 and KC10

#Number of max per depth
f1 <- c_max_n %>% 
  ...
  ylim(0, 180) +
  ylab("# Max Chl") +
  ggtitle("Chlorophyll Bottle Samples") +
  theme_bw() +
...
ggsave(here("figs_invent", "chl_max_dep_test.png"), fig,
